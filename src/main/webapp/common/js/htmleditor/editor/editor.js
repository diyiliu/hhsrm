    ...
    initView: function (sEditorId,sParentID) {
        ...
        var _toolbarStr = "\
            <div id='EDiaryEditor'style='width: 621px;'>\
                ...
                <div style='height: 200px; background-image: url("+base+"images/editor/guage.gif); padding-left: 39px; width: 582px!important ;' id='EDiaryEditorContent'>\
                    <iframe id='editor_body_area' name='editor_body_area' style='width: 550px; height: 200px; border-width: 0px; overflow-x: atuo; display: block;' frameborder='0'></iframe>\
