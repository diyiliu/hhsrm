...
(function ($) {
  var DatePicker = function () {
    var ids = {},
      ...
      tpl = {
        wrapper: '<div class="datepicker"><div class="datepickerBorderT" /><div class="datepickerBorderB" /><div class="datepickerBorderL" /><div class="datepickerBorderR" /><div class="datepickerBorderTL" /><div class="datepickerBorderTR" /><div class="datepickerBorderBL" /><div class="datepickerBorderBR" /><div style="position:relative;text-align:left;border:1px solid #ccc;"><div class="datepickerContainer"><table cellspacing="0" cellpadding="0"><tbody><tr></tr></tbody></table></div><div class="datepickerFooter"><a id="dp-search" class="pushBtn" hideFocus="true" href="javascript:;"><b>查询</b></a></div></div></div>',
        head: [
      ...
      layout = function(el) {
        ...
        cal.css({
          ...
          height: height + options.extraHeight + 34 + 'px'
        }).find('div.datepickerContainer').css({
          width: width + 'px',
          height: height + 'px'
        });
        cal.find('div.datepickerFooter').css({
          marginTop: height + options.extraHeight + 10 + 'px',
          width: width + 'px'
        });
      },
