...
(function ($) {
    ...
    }, message:"请输入有效的电子邮件地址"}, url:{validator:function (_27) {
    ...
    }, message:"请输入有效的URL地址"}, length:{validator:function (_28, _29) {
        var len = $.trim(_28).length;
        return len >= _29[0] && len <= _29[1];
    }, message:"输入内容长度必须介于{0}和{1}之间"}, remote:{validator:function (_2a, _2b) {
        var _2c = {};
        _2c[_2b[1]] = _2a;
