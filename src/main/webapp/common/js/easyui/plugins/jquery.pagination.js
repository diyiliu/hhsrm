...
/* 添加调整按钮 */
$("<span style=\"padding-left:2px;\"></span>").appendTo(tr).wrap("<td></td>");
bb.go = $("<a href=\"javascript:void(0)\" style=\"outline:none;\" hideFocus=\"true\"></a>").appendTo(tr).wrap("<td></td>");
bb.go.linkbutton({iconCls:"pagination-go", plain:true}).unbind("click").bind("click", function () {
	var _9 = parseInt($('.pagination-num').val()) || 1;
	_b(_2, _9);
	return false;
});
$("<span style=\"padding-left:2px;\"></span>").appendTo(tr).wrap("<td></td>");
