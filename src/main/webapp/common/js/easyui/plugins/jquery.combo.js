...
(function ($) {
	function _1(_2, _3) {
		...
		var _10 = _5.find(".combo-close");
		_5._outerWidth(_4.width)._outerHeight(_4.height);
		_7._outerWidth(_5.width() - _9 - _10._outerWidth());
		if($.browser.msie && $.browser.version >= 9){
			_7._outerWidth(_5.width() - _9 - _10._outerWidth() - 4);
		}
	...
	function _e(_f) {
		...
		$("<span><span class=\"combo-close\"></span><span class=\"combo-arrow\"></span></span>").appendTo(_10);
