...
<html>
  <head>
   <style type="text/css">
		...
		.welcome{width:100%;height:100%;background:url(<%=path %>/webfiles/common/skin/images/error/error_bg.jpg) no-repeat center center;position: relative;}
		.error_position{width:489px;height:214px;background: url(<%=path %>/webfiles/common/skin/images/error/2.png) no-repeat;position: relative;top:50%;margin-top:-107px;left:50%;margin-left:-244px}
