...
<%@ include file="/webfiles/common/include/includedlg.jsp"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
	<head>
		<script type="text/javascript"
			src="<%=path%>/webfiles/common/js/jquery/jquery.form.js"> </script>
	</head>
	<body>
		<form id="commoditytrackfileupload" name="commoditytrackfileupload"
			action="" method="post" enctype="multipart/form-data">
			<table class="ui-input-table">
				<tr>
					<td class="ui-input-table_title" style="width: 25%;">
						请选择文件：
					</td>
					<td style="width: 75%;">
